import TreatmentsHero from "@/app/(site)/treatments/_sections/TreatmentsHero";
import TreatmentsIndex from "@/app/(site)/treatments/_sections/TreatmentsIndex";
import TreatmentsDetail from "@/app/(site)/treatments/_sections/TreatmentsDetail";
import TreatmentsProcess from "@/app/(site)/treatments/_sections/TreatmentsProcess";
import TreatmentsFAQ from "@/app/(site)/treatments/_sections/TreatmentsFAQ";
