  ...
  return (
    <section className="py-16 md:py-20 bg-ivory-2">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="bg-ivory rounded-2xl overflow-hidden shadow-lg min-h-[600px] lg:min-h-[500px]">
          <div className="grid lg:grid-cols-2 h-full">
            ...
            <div className="p-8 lg:p-12 flex flex-col justify-center min-h-[400px] lg:min-h-[500px]">
              {/* Breadcrumbs */}
              <div className="text-sm text-ink/55 mb-4">
              ...
              <div className="space-y-4 mb-8">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <span className="text-ink/70">
                      {loc.ctaSecondaryHref ? (
                        <a href={loc.ctaSecondaryHref} className="hover:text-ink" target="_blank" rel="noopener noreferrer">
                          {loc.address.complete}
                        </a>
                      ) : (
                        loc.address.complete
                ...
                {loc.phoneDisplay && (
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-ink/70">
                      <a href={loc.phoneHref} className="hover:text-ink">
                        {loc.phoneDisplay}
                      </a>
                    </span>
                  </div>
                ...
                {loc.email && (
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-ink/70">
                      <a href={loc.emailHref} className="hover:text-ink">
                        {loc.email}
                      </a>
                    </span>
                  </div>
