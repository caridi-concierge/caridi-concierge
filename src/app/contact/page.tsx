...
export const metadata = createPageMetadata({
    ...
    description: "Book your personalized aesthetic consultation with Caridi Concierge. Contact us today to schedule wrinkle reduction, fillers, or IV therapy in NYC.",
    path: "/contact",
