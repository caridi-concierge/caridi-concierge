export const metadata = {
  title: "Where Botox Works Best | Common Treatment Areas Explained",
  ...
  description:
    "Learn where Botox works best, from forehead lines to jawline contouring. Dr. Cristina Caridi explains common treatment areas, benefits, and what to expect.",
  category: "Botox",
...
**Where to Get Botox?**  
At Caridi Concierge, all treatments are performed by me, [Dr. Cristina Caridi](/staff/cristina-caridi), in the comfort of your own home. You get medical-grade care from a licensed physician, with none of the hassle of waiting rooms or busy medspas. I serve clients across Brooklyn, Staten Island, and select NYC neighborhoods.  
...
- [Chin Botox](/blog/chin-botox-chin-filler-nyc)
