export const metadata = {
  title: "How Many Units of Botox for Forehead? | Cost & Results",
  ...
  description:
    "Forehead Botox typically uses 10–30 units. Learn about cost, results, safety, and what to expect from treatment with Dr. Caridi in NYC.",
  category: "Botox",
