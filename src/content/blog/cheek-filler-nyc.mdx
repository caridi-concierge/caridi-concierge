export const metadata = {
  ...
  description:
    "A clear guide to natural cheek contour, volume restoration, and midface lift. Learn what cheek filler is, how it works, what results to expect.",
...
### Where is Caridi Concierge located?
  - We are based in Red Hook, Brooklyn and provide mobile, in-home treatments across Brooklyn, Manhattan, and nearby neighborhoods. We are will also have clinic space in Gowanus, starting in January 2026!
...
### How can I book a consultation?
  - You can visit our [consultation page](/treatments/consult) or call or text us to schedule your appointment.
