export const metadata = {
  ...
  date: "2025-04-24 12:00:00Z",
  coverImage: "/images/cc_headshot_pink.jpg",
  description:
...
Typically there is no downtime. You may experience some mild bruising or swelling that will resolve within a few days.  
...
In addition to lip flips, we offer wrinkle relaxers (Botox, Daxxify), dermal fillers (RHA, Radiesse), and IV therapy.
