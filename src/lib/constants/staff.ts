...
export const staff: Staff[] = [
    {
      ...
      titleTag: "Cristina Caridi, MD | Physician & Founder of Caridi Concierge",
      metaDescription: "Cristina Caridi, MD is a physician-led aesthetic medicine provider offering personalized, safety-first care through Caridi Concierge in NYC."
    },
  ];
