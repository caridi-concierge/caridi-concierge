...
export const ctaVariants: Record<string, CTASectionProps> = {
  ...
  botox: {
    ...
    bgColor: "bg-outer-space",
    textColor: "text-alabaster",
    ariaLabel: "Request a consultation for Botox treatment with Caridi Concierge",
    id: "botox-cta",
  },
  fillers: {
    ...
    bgColor: "bg-outer-space",
    textColor: "text-alabaster",
    ariaLabel: "Request a consultation for dermal filler treatment with Caridi Concierge",
    id: "fillers-cta",
  },
  biostim: {
    ...
    bgColor: "bg-outer-space",
    textColor: "text-alabaster",
    ariaLabel: "Request a consultation for biostimulatory filler treatment with Caridi Concierge",
    id: "biostim-cta",
  },
  peels: {
    ...
    bgColor: "bg-outer-space",
    textColor: "text-alabaster",
    ariaLabel: "Request a consultation for chemical peel treatment with Caridi Concierge",
    id: "peels-cta",
  },
  consult: {
    ...
    bgColor: "bg-outer-space",
    textColor: "text-alabaster",
    ariaLabel: "Request a consultation with Dr. Cristina Caridi at Caridi Concierge",
    id: "consult-cta",
  },
  staff: {
